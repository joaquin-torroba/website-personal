  ...
  return (
    ...
    >
      <div className="prose lg:prose-lg dark:prose-invert max-w-3xl mx-auto pl-10 pr-4 space-y-4">
        <p className="text-lg">
          Soy Joaquin. Mi foco hoy está 100% en <em>inteligencia artificial</em> aplicada a negocios. Me inicié profesionalmente en el mundo corporativo, después pasé varios años trabajando en startups digitales, y ahora combino ambos enfoques. 
        </p>
        <p className="text-lg">
